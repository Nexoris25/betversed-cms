...
export interface ApiAccordionAccordion extends Struct.CollectionTypeSchema {
...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    main_review: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiBettingEducationBettingEducation
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['Guide', 'Tip', 'Others']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiBonusBonus extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    bonusSummary: Schema.Attribute.Component<
      ...
      false
    >;
    book_maker_name: Schema.Attribute.Relation<
      'oneToOne',
      'api::book-maker-list.book-maker-list'
    >;
    cons: Schema.Attribute.Component<'default.cons', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    howToActivateBonus: Schema.Attribute.RichText;
    ...
    pros: Schema.Attribute.Component<'default.pros', true>;
    publishedAt: Schema.Attribute.DateTime;
    seoMeta: Schema.Attribute.Component<'shared.seo', false>;
    ...
    typesOfBonuses: Schema.Attribute.RichText;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiBookMakerListBookMakerList
  extends Struct.CollectionTypeSchema {
  collectionName: 'book_maker_lists';
  info: {
    displayName: 'bookMakerList';
    pluralName: 'book-maker-lists';
    singularName: 'book-maker-list';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiBookmakerBookmaker extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    faqsSection: Schema.Attribute.Component<'shared.faqs-content', true>;
    finalVerdict: Schema.Attribute.Component<'shared.verdict-block', false>;
...
export interface ApiCountryListCountryList extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    slu: Schema.Attribute.UID<'title'>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPaymentMethodPaymentMethod
  ...
  attributes: {
    acceptableat: Schema.Attribute.String;
    bonuseligible: Schema.Attribute.Enumeration<['Yes', 'No']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Yes'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    depositspeed: Schema.Attribute.String;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    withdrawalspeed: Schema.Attribute.String;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::book-maker-list.book-maker-list': ApiBookMakerListBookMakerList;
